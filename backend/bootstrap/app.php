...
use App\Http\Middleware\CheckProviderActive;
use App\Http\Middleware\CorsForStorage;
use App\Http\Middleware\EnsureCustomerLegalOnboardingComplete;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        /**
         * ConfÃ­a en proxies durante desarrollo/local.
         */
        ...
        /**
         * CORS especÃ­fico para imÃ¡genes pÃºblicas servidas desde /storage.
         */
        ...
        $middleware->alias([
            ...
            'provider.active' => CheckProviderActive::class,
            'customer.legal.complete' =>
                EnsureCustomerLegalOnboardingComplete::class,
        ]);
    })
    ->withExceptions(function (Exceptions $exceptions): void {
         ...
         *
         * cuando una ruta protegida con auth:sanctum recibe una peticiÃ³n
         * sin token vÃ¡lido.
         */
        ...
        /**
         * Respuesta clara cuando una ruta API protegida no tiene token vÃ¡lido.
         */
