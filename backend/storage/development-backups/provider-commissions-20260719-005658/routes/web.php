...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::get('pagos', [\App\Http\Controllers\Admin\PaymentTransactionController::class, 'index'])->name('payments.index');
        Route::get('pagos/{paymentTransaction}', [\App\Http\Controllers\Admin\PaymentTransactionController::class, 'show'])->name('payments.show');
        Route::get('devoluciones', [\App\Http\Controllers\Admin\PaymentRefundController::class, 'index'])->name('refunds.index');
        Route::get('devoluciones/{paymentRefund}', [\App\Http\Controllers\Admin\PaymentRefundController::class, 'show'])->name('refunds.show');
        Route::post('devoluciones/{paymentRefund}/reintentar', [\App\Http\Controllers\Admin\PaymentRefundController::class, 'retry'])->name('refunds.retry');

        // AndanDO Provider Commissions Module
        Route::get('comisiones', [\App\Http\Controllers\Admin\ProviderCommissionController::class, 'index'])->name('commissions.index');
        Route::patch('comisiones/{provider}', [\App\Http\Controllers\Admin\ProviderCommissionController::class, 'update'])->name('commissions.update');
...
// === AndanDO Admin - Proveedores (suspender/reactivar) ===
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function () {
    Route::post('proveedores/{provider}/suspender', [\App\Http\Controllers\Admin\ProviderController::class, 'suspend'])->name('providers.suspend');
    Route::post('proveedores/{provider}/reactivar', [\App\Http\Controllers\Admin\ProviderController::class, 'reactivate'])->name('providers.reactivate');
});
